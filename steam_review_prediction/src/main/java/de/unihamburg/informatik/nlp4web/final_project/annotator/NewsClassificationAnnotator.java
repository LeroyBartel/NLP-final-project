...
import de.unihamburg.informatik.nlp4web.final_project.feature.LexicallyFrequencyExtractor;
...
public class NewsClassificationAnnotator extends CleartkAnnotator<String> {
    ...
    public void initialize(UimaContext context) throws ResourceInitializationException {
        ...
        try {
            ...
            LexicallyFrequencyExtractor<NewsAnnotation> lexFreqExtractor = initLexFreqExtractor();
    ...
    private LexicallyFrequencyExtractor<NewsAnnotation> initLexFreqExtractor() 
    		throws IOException {

        LexicallyFrequencyExtractor<NewsAnnotation> lexFreqExtractor = new LexicallyFrequencyExtractor<NewsAnnotation>(Sentence.class);
        return lexFreqExtractor;
    }
